...
- **原创文案** (faster & cheaper): fast-writing -> fast-clip-data -> video-composing -> magic-video
  - 3 modes: 热门影视 / 原声混剪 / 冷门新剧
...
|------|-------------------|
| `popular-learning` | 二创文案 Step 1 |
| `generate-writing` | 二创文案 Step 2 |
| `fast-writing` | 原创文案 Step 1 |
| `clip-data` | 二创文案 Step 3 |
| `fast-clip-data` | 原创文案 Step 2 |
| `video-composing` | 二创文案 Step 4 / 原创文案 Step 3 |
